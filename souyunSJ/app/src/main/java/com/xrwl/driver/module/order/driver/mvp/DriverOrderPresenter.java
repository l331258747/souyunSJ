 ...
 */
public class DriverOrderPresenter extends DriverOrderContract.APresenter {

    private DriverOrderContract.IModel mModel;
    private List<Order> mDatas;

    public DriverOrderPresenter(Context context) {
        super(context);
        mModel = new DriverOrderModel();
    }
