...
public class HomesAdAdapter extends PagerAdapter {
    ...
    public HomesAdAdapter(Context context, ViewPager viewPager, List<HomeItem> datas, OnHomeAdListener l) {
        mDatas = datas;
        mContext = context;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        View view = View.inflate(mContext, R.layout.homes_ad_viewpager_item, null);
