...
public abstract class CommonParamsInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if ("GET".equals(originRequest.method())) {
            ...
            Map<String, String> queryParamMap = getQueryParamMap(originRequest);
            ...
            if (body != null && body instanceof FormBody) {
                ...
                Map<String, String> newFormBodyParamMap = getFormBodyParamMap(formBodyParamMap);
                if (newFormBodyParamMap != null) {
                    ...
                    for (Map.Entry<String, String> entry : formBodyParamMap.entrySet()) {
                        bodyBuilder.add(entry.getKey(), URLEncoder.encode(entry.getValue(), "UTF-8"));
                    }
                ...
                Map<String, String> extraFormBodyParamMap = getMultiBodyParamMap();
    ...
    public abstract Map<String, String> getQueryParamMap(Request request);

    public abstract Map<String, String> getFormBodyParamMap(Map<String, String> originParams);

    public abstract Map<String, String> getMultiBodyParamMap();
