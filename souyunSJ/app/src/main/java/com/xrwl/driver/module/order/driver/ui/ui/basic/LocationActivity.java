package com.xrwl.driver.module.order.driver.ui.ui.basic;
...
import com.xrwl.driver.module.order.driver.ui.util.Utils;
    ...
    private void initMap() {
        if (aMap == null) {
            ...
            geoMarker = aMap.addMarker(new MarkerOptions().anchor(0.5f, 0.5f)
                    .icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.punch_dw))));
        }
