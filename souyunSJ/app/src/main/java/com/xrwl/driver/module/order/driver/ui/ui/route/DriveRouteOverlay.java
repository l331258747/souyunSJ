package com.xrwl.driver.module.order.driver.ui.ui.route;
...
public class DriveRouteOverlay extends RouteOverlay {
    ...
    private DrivePath walkPath;
	public DriveRouteOverlay(Context context, AMap amap, DrivePath path,
    ...
    public void addToMap() {
        ...
        initPolylineOptions();
        try {
            List<DriveStep> walkPaths = walkPath.getSteps();
            mPolylineOptions.add(startPoint);
            for (int i = 0; i < walkPaths.size(); i++) {
                DriveStep walkStep = walkPaths.get(i);
     ...
     * @param walkStep
     */
    private void addWalkPolyLines(DriveStep walkStep) {
     ...
     * @param position
     */
    private void addWalkStationMarkers(DriveStep walkStep, LatLng position) {
