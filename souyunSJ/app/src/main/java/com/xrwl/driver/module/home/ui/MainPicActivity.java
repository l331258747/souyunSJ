...
public class MainPicActivity extends AppCompatActivity implements BannerLayout.OnBannerItemClickListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pic_lunbo);
       ...
       // BannerLayout bannerVertical =  findViewById(R.id.recycler_ver);
        ...
        webBannerAdapter.setOnBannerItemClickListener(new BannerLayout.OnBannerItemClickListener() {
            ...
            public void onItemClick(int position) {
                Toast.makeText(MainPicActivity.this, "点击了第  " + position+"  项", Toast.LENGTH_SHORT).show();
            }
        });
...
//        });
    ...
    public void jump(View view) {
        startActivity(new Intent(MainPicActivity.this, NormalActivity.class));
    }
    public void jumpOverFlying(View view) {
        startActivity(new Intent(MainPicActivity.this, OverFlyingActivity.class));
    }
